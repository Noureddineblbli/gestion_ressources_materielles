...
export default function ResourceManagerProfile() {
  ...
  useEffect(() => {
    if (user) {
      setFormData((prev) => ({
        ...
        name: user.name || "",
        email: user.email || "",
        department: user.department || "Service des ressources",
      }))
    }
  }, [user])
  ...
  return (
    <ResourceManagerLayout title="Profil gestionnaire" subtitle="Gérez vos informations personnelles">
